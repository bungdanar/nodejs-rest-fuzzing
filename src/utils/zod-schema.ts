...
export class ZodSchemaUtility {
  private static tagCreatePartialZodValidationSchema = () =>
    z.array(z.string()).nonempty()

  private static categoryCreatePartialZodValidationSchema = () =>
    z.object({
      name: z.string(),
      description: z.string(),
    })

  private static couponCreatePartialZodValidationSchema = () =>
    z.object({
      code: z.string(),
      description: z.string(),
  ...
  private static tagCreateFullZodValidationSchema = () =>
    z.array(z.string().min(3).max(255)).nonempty()

  private static categoryCreateFullZodValidationSchema = () =>
    z.object({
      name: z.string().min(3).max(255),
      description: z.string().min(3).max(1000),
    })

  private static couponCreateFullZodValidationSchema = () =>
    z
      .object({
  ...
  static productCreatePartialZodValidationSchema = () =>
    z.object({
      name: z.string(),
      sku: z.string(),
  ...
  static productTagCategoryCouponCreatePartialZodValidationSchema = () =>
    this.productCreatePartialZodValidationSchema().extend({
      ...
      categories: z
        ...
        .nonempty(),
      coupons: z
        .array(this.couponCreatePartialZodValidationSchema())
        .nonempty(),
    })
   ...
   */
  static productCreateFullZodValidationCoreSchema = () =>
    z.object({
      name: z.string().min(3).max(255),
   ...
   */
  static productCreateFullZodValidationRefinedSchema = () =>
    z
      .object({
        name: z.string().min(3).max(255),
        sku: z.string().min(3).max(255),
  ...
  static userCreatePartialZodValidationSchema = () =>
    z.object({
      first_name: z.string(),
      last_name: z.string(),
      email: z.string(),
  ...
  private static addressCreatePartialZodValidationSchema = () =>
    z.object({
      street: z.string(),
      city: z.string(),
      country: z.string(),
  ...
  private static shippingCreatePartialZodValidationSchema = () =>
    z.object({
      description: z.string(),
  ...
  static userCreateFullZodValidationSchema = () =>
    z.object({
  ...
  private static addressCreateFullZodValidationSchema = () =>
    z.object({
  ...
  private static shippingCreateFullZodValidationSchema = () =>
    z.object({
      description: z.string().min(3).max(1000),
  ...
  static userAddrProdCreateFullZodValidationSchema = () =>
    this.userCreateFullZodValidationSchema().extend({
      addresses: z
        .array(this.addressCreateFullZodValidationSchema())
        .nonempty(),
